    ...
    <div className={styles.page}>
      <div className={styles.hero}>
        ...
        <p className={styles.subtitle}>
          Account management for the FIO API
        </p>
        <p className={styles.description}>
          Manage your FIO account, API keys, permissions and groups for your
          Prosperous Universe data.
        </p>
      ...
      <div className={styles.info}>
        ...
        <div className="card">
          ...
          <p>
            ...
            players and manage group permissions for your corporation.
          </p>
        </div>
      </div>
    </div>
